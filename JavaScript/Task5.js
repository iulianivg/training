...
//strings representing directions to walk (eg. ['n', 's', 'w', 'e']). You always walk 
//only a single block for each letter (direction) and you know it takes you one minute to 
